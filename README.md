...
| 날짜 | 커밋 | 변경 내용 |
|---|---|---|
| 2026-05-09 | `33592d1` | 초기 구현 — HTML/CSS/JS 전체 새로 작성 |
| 2026-05-09 | `271b247` | README 기획서 작성 — 요구사항 분석, 단계별 개발 과정, AI 활용 기록, 회고 추가 |
| 2026-05-09 | `85b99c5` | UI 구조 개편 — 과제 와이어프레임(Header/InputArea/TodoList/StatusArea)에 맞게 섹션 재구성 |
| 2026-05-09 | `0c4a5c0` | 점선 테두리 제거 — `border: dashed` → `box-shadow`로 교체 |
| 2026-05-09 | `b695464` | Todo 아이템 간격 개선 — 아이템 사이 여백 추가(`gap: 10px`) |
